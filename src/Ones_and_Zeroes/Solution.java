...
public class Solution {
	...
	public static void main(String[] args) {
        ...
        System.out.println(s.findMaxForm(new String[]{"10","1","0"},1,1));//2
        System.out.println(s.findMaxForm(new String[]{"10","0001","111001","1","0"},4,3));//3
        System.out.println(s.findMaxForm(new String[]{"0","11","1000","01","0","101","1","1","1","0","0","0","0","1","0","0110101","0","11","01","00","01111","0011","1","1000","0","11101","1","0","10","0111"},9,80));//17
	}
}