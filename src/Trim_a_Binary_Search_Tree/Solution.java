...
public class Solution {
	...
	public static void main(String[] args) {
        ...
        System.out.println(s.trimBST(new Tree(new Object[]{1, 2, 2}).root, 1, 2));
        System.out.println(s.trimBST(new Tree(new Object[]{3, 0, 4, null, 2, null, null, null, null, 1}).root, 1, 3));
	}
}